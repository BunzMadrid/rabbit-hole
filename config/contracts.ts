export const CONTRACTS = {
  RABBITHOLE_TOKEN: {
    address: (process.env.NEXT_PUBLIC_CONFIDENTIAL_CLUB_ADDRESS || '') as `0x${string}`,
    abi: [
  {
    "inputs": [
      {
  ...
  },
  {
    ...
    "name": "getUserPendingConversions",
    "outputs": [
      {
        "internalType": "uint256[]",
        "name": "pendingIds",
